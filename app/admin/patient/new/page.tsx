...
export default function NewPatient() {
  ...
  async function createPatient(formData: FormData) {
    ...
    // In a real app we'd abstract this or use the Service, but since it requires bcrypt:
    ...
    redirect(`/admin/patient/${newPatient.id}`)
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0b1326] text-slate-900 dark:text-[#dae2fd] transition-colors duration-300">
      ...
      <main className="max-w-2xl mx-auto px-8 py-8">
        <form action={createPatient} className="bg-white dark:bg-[#171f33] rounded-2xl shadow-sm dark:shadow-[0_20px_40px_rgba(6,14,32,0.4)] border border-slate-100 dark:border-white/5 p-8 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-slate-500 dark:text-[#8392a6] mt-2">The patient will use this to log into the Patient Portal.</p>
            </div>
          </div>
